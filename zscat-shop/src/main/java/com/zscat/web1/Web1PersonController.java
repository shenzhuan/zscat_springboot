...
import com.zsTrade.web.sys.utils.SysUserUtils;
	 ...
	 */
@Controller
@RequestMapping("/web1/person")
public class Web1PersonController {
	...
	private ArticleService articleService;
	 @RequestMapping("")
	  public ModelAndView index() {
	        try {
	            ModelAndView model = new ModelAndView("/web1/person/index");
...
//	            model.addObject("conponCount", conponCount);
	 ...
	 @RequestMapping("/information")
	  public ModelAndView information() {
		 ModelAndView model = new ModelAndView("/web1/person/User_Personalinfo");
         SysUser member=SysUserUtils.getSessionLoginUser();
         model.addObject("member", member);
	 ...
	 @RequestMapping("/safety")
	  public ModelAndView safety() {
		 ModelAndView model = new ModelAndView("/web1/person/safety");
	 ...
	 @RequestMapping("/address")
	  public ModelAndView address() {
		 ModelAndView model = new ModelAndView("/web1/person/User_address");
	...
	Map<String, String> saveAddress1(@ModelAttribute Address address) throws Exception {
	 ...
	 @RequestMapping("/cardlist")
	  public ModelAndView cardlist() {
		 ModelAndView model = new ModelAndView("/web1/person/cardlist");
	 ...
	 @RequestMapping("/cardmethod")
	  public ModelAndView cardmethod() {
		 ModelAndView model = new ModelAndView("/web1/person/cardmethod");
		 Payment Payment=new Payment();
		 Payment.setIsDel(1);
		 List<Payment> payList=PaymentService.select(Payment);
		 model.addObject("page", payList);
	 ...
	 @RequestMapping("/order")
	  public ModelAndView order() {
		 ModelAndView model = new ModelAndView("/web1/person/User_Orderform");
	 ...
	 @RequestMapping("/change")
	  public ModelAndView change() {
		 ModelAndView model = new ModelAndView("/web1/person/change");
	 ...
	 @RequestMapping("/comment")
	  public ModelAndView comment() {
		 ModelAndView model = new ModelAndView("/web1/person/comment");
	 ...
	 @RequestMapping("/points")
	  public ModelAndView points() {
		 ModelAndView model = new ModelAndView("/web1/person/User_integral");
	 ...
	 @RequestMapping("/coupon")
	  public ModelAndView coupon() {
		 ModelAndView model = new ModelAndView("/web1/person/User_coupon");
	 ...
	 @RequestMapping("/bonus")
	  public ModelAndView bonus() {
		 ModelAndView model = new ModelAndView("/web1/person/bonus");
	 ...
	 @RequestMapping("/walletlist")
	  public ModelAndView walletlist() {
		 ModelAndView model = new ModelAndView("/web1/person/walletlist");
	 ...
	 @RequestMapping("/bill")
	  public ModelAndView bill() {
		 ModelAndView model = new ModelAndView("/web1/person/bill");
	 ...
	 @RequestMapping("/collection")
	  public ModelAndView collection() {
		 ModelAndView model = new ModelAndView("/web1/person/User_Collect");
...
//		 model.addObject("page", page);
	 ...
	 @RequestMapping("/foot")
	  public ModelAndView foot(HttpServletRequest req) {
		 ModelAndView model = new ModelAndView("/web1/person/foot");
...
//			}
	 ...
	 @RequestMapping("/consultation")
	  public ModelAndView consultation() {
		 ModelAndView model = new ModelAndView("/web1/person/consultation");
	 ...
	 @RequestMapping("/suggest")
	  public ModelAndView suggest() {
		 ModelAndView model = new ModelAndView("/web1/person/suggest");
	 ...
	 @RequestMapping("/news")
	  public ModelAndView news() {
		 ModelAndView model = new ModelAndView("/web1/person/news");
	 ...
	 */
	 @RequestMapping("/cartList")
	  public ModelAndView cartList() {
		 ModelAndView model = new ModelAndView("/web1/cartList");
...
//		 	}
	 ...
	 @RequestMapping("submitOrder")
		public ModelAndView submitOrder(@RequestParam(value = "cartIds") String[] cartIds,
			...
			ModelAndView mav=new ModelAndView();
			Order order=OrderService.insertOrder(cartIds,addressid,paymentid,"qq");
			 Payment Payment=new Payment();
			 Payment.setIsDel(1);
			 List<Payment> payList=PaymentService.select(Payment);
			 mav.addObject("payList", payList);
			 if(order==null){
				 mav.setViewName("web1/forwad");
			 }else{
				 mav.setViewName("web1/success");
			 }
	 ...
	 @RequestMapping("/selledProduct/{id}")
		public ModelAndView selledProduct(@PathVariable("id") Long id)throws Exception{
			...
			mav.setViewName("web1/person/order");
			return mav;
		}
	 /**
	  *交易详情
	 ...
	 @RequestMapping("/orderDetail/{id}")
		public ModelAndView orderDetail(@PathVariable("id") Long id)throws Exception{
			...
			Product b=ProductService.selectByPrimaryKey(id);
			mav.addObject("Product", b);
			mav.setViewName("web1/person/orderinfo");
			return mav;
		}
	 /**
	  * 物流
