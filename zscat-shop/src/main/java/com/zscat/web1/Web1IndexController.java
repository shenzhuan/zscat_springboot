...
@Controller
@RequestMapping("/web1")
public class Web1IndexController {
	...
	private ProductTypeService ProductTypeService;
	 ...
	 @RequestMapping("")
	  public ModelAndView index() {
	        try {
	            ModelAndView model = new ModelAndView("/web1/index");
	 ...
	 @RequestMapping("/index")
	  public ModelAndView index1() {
	        try {
	            ModelAndView model = new ModelAndView("/web1/home3");
	            Product goods=new Product();
	            PageInfo<Product> page = ProductService.selectPage(1, 4, goods,"orderby desc");
	            model.addObject("page", page);
	            ProductClass gc=new ProductClass();
	 ...
	 @RequestMapping("/information/{createBy}")
	  public ModelAndView information(@PathVariable("createBy") Long createBy) {
		 ModelAndView model = new ModelAndView("/web1/person/information");
	 ...
	 @RequestMapping("/newD/{id}")
	  public ModelAndView newD(@PathVariable("id") Long id) {
		 ModelAndView model = new ModelAndView("/web1/person/blog");
...
//			}
		...
		@RequestMapping("/search/{createBy}")
		  public ModelAndView search(@PathVariable("createBy") Long createBy) {
			 ModelAndView model = new ModelAndView("/web1/search");
		...
		@RequestMapping("/memberList")
		  public ModelAndView memberList() {
			 ModelAndView model = new ModelAndView("/web1/member");
		...
		@RequestMapping("/type")
		  public ModelAndView type() {
			 ModelAndView model = new ModelAndView("/web1/type");
			 ProductClass gc=new ProductClass();
	            gc.setParentId(1L);
	            List<ProductClass> gcList=ProductClassService.selectPage(1, 15, gc).getList();
	            model.addObject("gcList", gcList);
		...
		@RequestMapping("/Limit_buy")
		  public ModelAndView Limit_buy() {
			 ModelAndView model = new ModelAndView("/web1/Limit_buy");
			 ProductClass gc=new ProductClass();
	            gc.setParentId(1L);
	            List<ProductClass> gcList=ProductClassService.selectPage(1, 15, gc).getList();
	            model.addObject("gcList", gcList);
		...
		@RequestMapping("/Brands")
		  public ModelAndView Brands() {
			 ModelAndView model = new ModelAndView("/web1/Brands");
			 ProductClass gc=new ProductClass();
	            gc.setParentId(1L);
	            List<ProductClass> gcList=ProductClassService.selectPage(1, 15, gc).getList();
	            model.addObject("gcList", gcList);
	...
	@RequestMapping("/product_list")
	  public ModelAndView product_list() {
		 ModelAndView model = new ModelAndView("/web1/product_list");
		 ProductClass gc=new ProductClass();
            gc.setParentId(1L);
            List<ProductClass> gcList=ProductClassService.selectPage(1, 15, gc).getList();
            model.addObject("gcList", gcList);
